...
/** {@link ConfigOption}s for {@link OdpsCatalog}. */
@Internal
public final class OdpsCatalogFactoryOptions {

    public static final String IDENTIFIER = "odps";

    public static final ConfigOption<String> DEFAULT_PROJECT =
            ConfigOptions.key(CommonCatalogOptions.DEFAULT_DATABASE_KEY)
                    .stringType()
                    .noDefaultValue();

    public static final ConfigOption<String> ODPS_CONF_DIR =
            ConfigOptions.key("odps-conf-dir")
                    .stringType()
                    .noDefaultValue();
