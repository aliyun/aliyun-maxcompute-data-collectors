...
public class TableUpsertSessionProviderImpl implements TableWriteSessionProvider {
    ...
    public TableUpsertSession createUpsertSession(TableWriteSessionBuilder builder) throws IOException {
        if (builder.getSessionId() == null) {
            return new TableUpsertSessionImpl(builder.getIdentifier(),
            ...
            return new TableUpsertSessionImpl(builder.getIdentifier(), builder.getTargetPartitionSpec(),
