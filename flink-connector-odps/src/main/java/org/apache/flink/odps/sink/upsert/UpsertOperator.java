 ...
 */
public class UpsertOperator extends AbstractWriteOperator<RowData> {

    public UpsertOperator(UpsertOperatorFactory.OdpsUpsertOperatorFactoryBuilder builder) {
        super(new UpsertFunction(builder.getConf(),
                builder.getOdpsConf(),
