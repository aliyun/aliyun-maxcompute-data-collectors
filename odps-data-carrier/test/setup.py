...
def prepare_data():
    ...
    hdfs_udtf_path = "/mma/data-transfer-hive-udtf-1.0-SNAPSHOT-jar-with-dependencies.jar"
    ...
    commands = [
        ...
        "create function extend_table as '%s' using jar '%s';" % (class_name,
                                                                  config.hdfs_address + hdfs_udtf_path),
        insert_overwrite_non_partitioned_tbl_statement("TEST_TEXT", 10000),
        insert_overwrite_non_partitioned_tbl_statement("TEST_ORC", 10000),
        insert_overwrite_non_partitioned_tbl_statement("TEST_PARQUET", 10000),
        insert_overwrite_non_partitioned_tbl_statement("TEST_RCFILE", 10000),
        insert_overwrite_non_partitioned_tbl_statement("TEST_SEQUENCEFILE", 10000),
        insert_overwrite_non_partitioned_tbl_statement("TEST_NON_PARTITIONED_1M",
                                                       1000000),
    ]

    for i in range(100):
        commands.append(insert_overwrite_partitioned_tbl_statement("TEST_TEXT_PARTITIONED_100x10K",
                                                                   random_string(5),
                                                                   random_bigint(),
                                                                   10000))
        commands.append(insert_overwrite_partitioned_tbl_statement("TEST_ORC_PARTITIONED_100x10K",
                                                                   random_string(5),
                                                                   random_bigint(),
                                                                   10000))
        commands.append(insert_overwrite_partitioned_tbl_statement(
            "TEST_PARQUET_PARTITIONED_100x10K", random_string(5), random_bigint(), 10000))
        commands.append(insert_overwrite_partitioned_tbl_statement(
            "TEST_RCFILE_PARTITIONED_100x10K", random_string(5), random_bigint(), 10000))
        commands.append(insert_overwrite_partitioned_tbl_statement(
            "TEST_SEQUENCEFILE_PARTITIONED_100x10K", random_string(5), random_bigint(), 10000))
        commands.append(insert_overwrite_partitioned_tbl_statement(
    ...
    commands.append(insert_overwrite_partitioned_tbl_statement("TEST_ORC_PARTITIONED_100x10K",
                                                               ...
                                                               123456,
                                                               10000))
    commands.append(insert_overwrite_partitioned_tbl_statement("TEST_PARQUET_PARTITIONED_100x10K",
                                                               "mma_test",
                                                               123456,
                                                               10000))
    commands.append(insert_overwrite_partitioned_tbl_statement("TEST_RCFILE_PARTITIONED_100x10K",
                                                               "mma_test",
                                                               123456,
                                                               10000))
    commands.append(insert_overwrite_partitioned_tbl_statement(
        "TEST_SEQUENCEFILE_PARTITIONED_100x10K", "mma_test", 123456, 10000))
