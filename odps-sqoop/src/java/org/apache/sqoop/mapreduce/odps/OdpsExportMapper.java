...
public class OdpsExportMapper 
    extends com.cloudera.sqoop.mapreduce.AutoProgressMapper<LongWritable,
    Record, SqoopRecord, NullWritable> {

  private SqoopRecord odpsImpl;

  public static final Log LOG 
      = LogFactory.getLog(OdpsExportMapper.class.getName());
  ...
  protected void setup(Context context) 
    ...
    try {
      ...
      odpsImpl = (SqoopRecord) ReflectionUtils.newInstance(cls, conf);
