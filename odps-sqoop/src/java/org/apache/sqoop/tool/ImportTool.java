...
public class ImportTool extends com.cloudera.sqoop.tool.BaseSqoopTool {
  ...
  protected RelatedOptions getImportOptions() {
    ...
    if (!allTables) {
      ...
      importOpts.addOption(OptionBuilder.withArgName("hdfs-dir to import")
          .hasArg().withDescription("HDFS directory to import")
