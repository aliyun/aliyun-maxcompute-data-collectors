...
class OdpsWriterSuite extends AnyFunSuite {
  ...
  test("test odps writer attempt number") {
    try {
      ...
      val context2 = new TaskContextImpl(0, 1, 0, 0, 0, null, null, null, cpus = 0)
      ...
      val context3 = new TaskContextImpl(0, 1, 0, 0, 1, null, null, null, cpus = 0)
      ...
      val context4 = new TaskContextImpl(0, 2, 0, 0, 1, null, null, null, cpus = 0)
      ...
      val context5 = new TaskContextImpl(0, Short.MaxValue, 0, 0, 0, null, null, null, cpus = 0)
      ...
      val context6 = new TaskContextImpl(0, Short.MaxValue, 0, 0, (1 << 16) - 1, null, null, null, cpus = 0)
      ...
      val context7 = new TaskContextImpl(0, 0, 0, 0, (1 << 17) - 1, null, null, null, cpus = 0)
      ...
      val context8 = new TaskContextImpl(0, 1, 0, 0, (1 << 17) - 1, null, null, null, cpus = 0)
