...
import com.aliyun.odps.table.write.{BatchWriter, WriterAttemptId, WriterCommitMessage => OdpsWriterCommitMessage}
...
import org.apache.spark.sql.execution.datasources.v2.odps.vectorized.ArrowBatchWriter
