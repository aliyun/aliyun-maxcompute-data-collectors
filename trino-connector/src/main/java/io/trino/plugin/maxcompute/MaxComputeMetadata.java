...
import io.trino.plugin.maxcompute.utils.MaxComputeMetaCache;
import io.trino.plugin.maxcompute.utils.MaxComputeUtils;
import io.trino.plugin.maxcompute.utils.TypeConvertUtils;
        ...
        implements ConnectorMetadata
{
    ...
    @Inject
    public MaxComputeMetadata(MaxComputeConfig config)
    {
...
//    @Override
//    public ConnectorTableLayout getTableLayout(ConnectorSession session, ConnectorTableMetadata tableMetadata)
//    {
