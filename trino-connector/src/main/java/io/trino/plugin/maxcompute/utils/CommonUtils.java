...
public class CommonUtils
{
    ...
    public static String serialize(Serializable object)
    {
        try {
            ...
            throw new TrinoException(MaxComputeErrorCode.MAXCOMPUTE_CONNECTOR_ERROR, "serialize object error", e);
        }
    }
    ...
    public static Object deserialize(String serializedString)
    {
        try {
            ...
            throw new TrinoException(MaxComputeErrorCode.MAXCOMPUTE_CONNECTOR_ERROR, "deserialize object error", e);
        }
    }
}
